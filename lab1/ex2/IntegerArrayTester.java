...
final class IntegerArray {
    ...
    public IntegerArray getSorted() {
        return new IntegerArray(Arrays.stream(this.a).sorted().toArray());
    }
    ...
    public IntegerArray concat(IntegerArray ia) {
        int[] tempArray = new int[a.length + ia.length()];
        System.arraycopy(a, 0, tempArray, 0, a.length);
        System.arraycopy(ia.getA(), 0, tempArray, a.length, ia.length());
    ...
    public boolean equals(Object o) {
        ...
        return Arrays.equals(a, other.getA());
    }
}
